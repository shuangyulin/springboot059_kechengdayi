    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="简要" prop="jianyao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="简要"
                  v-model="ruleForm.jianyao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianyao" label="简要" prop="jianyao">
                    <span>{{ruleForm.jianyao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kemu = true;
          ...
          if(o=='jianyao'){
            this.ruleForm.jianyao = obj[o];
	    this.ro.jianyao = true;
            continue;
          }
        }
      }
