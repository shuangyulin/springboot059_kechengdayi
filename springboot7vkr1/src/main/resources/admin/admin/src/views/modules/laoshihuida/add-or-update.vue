<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="问题" prop="wenti">
          <el-input v-model="ruleForm.wenti" 
              placeholder="问题" clearable  :readonly="ro.wenti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="问题" prop="wenti">
              <el-input v-model="ruleForm.wenti" 
                placeholder="问题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="问题描述" prop="wentimiaoshu">
          <el-input v-model="ruleForm.wentimiaoshu" 
              placeholder="问题描述" clearable  :readonly="ro.wentimiaoshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="问题描述" prop="wentimiaoshu">
              <el-input v-model="ruleForm.wentimiaoshu" 
                placeholder="问题描述" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="问题解答" prop="wentijieda">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wentijieda" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wentijieda" label="问题解答" prop="wentijieda">
                    <span v-html="ruleForm.wentijieda"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.laoshixingming = true;
          ...
          if(o=='wentijieda'){
            this.ruleForm.wentijieda = obj[o];
	    this.ro.wentijieda = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.laoshizhanghao!=''&&json.laoshizhanghao){
              		this.ruleForm.laoshizhanghao = json.laoshizhanghao
		}
		if(json.laoshixingming!=''&&json.laoshixingming){
	...
	this.ruleForm.wentijieda = this.ruleForm.wentijieda.replace(reg,'../../../springboot7vkr1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `laoshihuida/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.laoshihuidaCrossAddOrUpdateFlag = false;
                  this.parent.search();
